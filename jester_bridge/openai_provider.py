...
class OpenAIProvider(AgentProvider):
    ...
    def _build_system_prompt(self, role: str) -> str:
        ...
        if role == Role.ARCHITECT.value:
            ...
            return (
                ...
                "Your objective is to independently inspect code diffs, verify acceptance criteria, "
                "check test outcomes, identify potential regressions, security, or privacy invariant "
    ...
    def _build_user_prompt(self, request: InvocationRequest) -> str:
        ...
        # Any extra context (e.g. diffs, error traces, notes)
